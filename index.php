...
<head>
 ...
 <meta property="og:title" content="Study Game Development - Study Online" />
...
<body class="dark">
 <div id="marker"></div>
 <nav id="nav-button" role="navigation">
  <button type="button" aria-controls="nav-main" aria-haspopup="menu" id="button-nav-main">
   <span class="menu-icon" aria-hidden="true">
    <svg version='1.1' x='0px' y='0px' width='50px' height='37px' viewBox='0 0 50 37'>
     <rect x='5'  y='10' width='20' height='5' />
     <rect x='25' y='10' width='20' height='5' />
     <rect x='5'  y='22' width='20' height='5' />
     <rect x='25' y='22' width='20' height='5' />
    </svg>
   </span>
   Menu
  </button>
 ...
 <header role="banner">
  <h1 id="global-title"><a data-char="StudyGameDev" aria-label="Header Title" href="#" tabIndex="1">StudyGameDev</a></h1>
 </header>

 <div id="draw-dark"></div>

 <nav id="nav-main" role="dialog" aria-label="Main">
  <nav id="nav-button-open"></nav>
  <ul role="menu">
   <li role="menuitem" tabindex='-1'>
    <button type="button" id="button-settings-accessibility" aria-label="Open the accessibilities settings" aria-controls="settings-accessibility" aria-haspopup="menu">Accessibility</button>
   </li>
   <li role="menuitem" tabindex='-1'>
    <a class="icon-external-link" href="https://twitter.com/nitro_nova">My Twitter</a>
   </li>
   <li role="menuitem" class="submenu-li" tabindex='-1'>
    <button type="button" id="button-ul-programming" aria-controls="ul-programming" aria-haspopup="menu" class="button-submenu red">Programming</button>
    <ul id="ul-programming" tabIndex="-1">
     <li><a to="prog-intro" href="#">Intro to Programming</a></li>
     <li><a to="prog-c" href="#">Learn C</a></li>
     <li><a to="prog-lua" href="#">Learn Lua</a></li>
     <li><a to="prog-eng-love2d" href="#">Love2D (Lua)</a></li>
    </ul>
   </li>
   <li role="menuitem" class="submenu-li" tabindex='-1'>
    <button type="button" id="button-ul-writing" aria-controls="ul-writing" aria-haspopup="menu" class="button-submenu scarlet">Writing</button>
    <ul id="ul-writing" tabIndex="-1">
     <li><a to="writ-intro" href="#">Intro to Writing</a></li>
    </ul>
   </li>
   <li role="menuitem" class="submenu-li" tabindex='-1'>
    <button type="button" id="button-ul-writing" aria-controls="ul-writing" aria-haspopup="menu" class="button-submenu orange">Sound Design</button>
    <ul id="ul-sound-design" tabIndex="-1">
     <li><a to="sd-intro" href="#">Intro to Sound Design</a></li>
     <li><a to="sd-fundamentals" href="#">Fundamentals of Audio</a></li>
     <li><a to="sd-recording" href="#">Recording Techniques</a></li>
     <li><a to="sd-processing" href="#">Processing Techniques</a></li>
    </ul>
   </li>
   <li role="menuitem" class="submenu-li" tabindex='-1'>
    <button type="button" id="button-ul-writing" aria-controls="ul-writing" aria-haspopup="menu" class="button-submenu yellow">Music Production</button>
    <ul id="ul-music-production" tabIndex="-1">
     <li><a to="mp-intro" href="#">Intro to Music Production</a></li>
     <li><a to="mp-music-theory" href="#">Music Theory</a></li>
     <li><a to="mp-tracking-stage" href="#">Tracking Stage</a></li>
     <li><a to="mp-mixing-stage" href="#">Mixing and Mastering</a></li>
     <li><a to="mp-applications" href="#">Applications of Video Game Music</a></li>
    </ul>
   </li>
   <li role="menuitem" class="submenu-li" tabindex='-1'>
    <button type="button" id="button-ul-writing" aria-controls="ul-writing" aria-haspopup="menu" class="button-submenu lime">Art</button>
    <ul id="ul-art" tabIndex="-1">
     <li><a to="art-intro" href="#">Intro to Art</a></li>
     <li><a to="art-fundamentals-topic" href="#">Art Fundamentals</a></li>
     <li><a to="art-human-anatomy-topic" href="#">Human Anatomy</a></li>
     <li><a to="art-drawing" href="#">Drawing Other Things</a></li>
     <li><a to="art-specializations" href="#">Types of Artists</a></li>
     <li><a to="art-animation" href="#">2D Animation</a></li>
    </ul>
   </li>
   <li role="menuitem" class="submenu-li" tabindex='-1'>
    <button type="button" id="button-ul-writing" aria-controls="ul-writing" aria-haspopup="menu" class="button-submenu green">3D Modelling</button>
    <ul id="ul-3d-modelling" tabIndex="-1">
     <li><a to="3d-intro" href="#">Intro to 3D</a></li>
     <li><a to="3d-softwares" href="#">3D Software</a></li>
     <li><a to="3d-animation-topic" href="#">3D Animation</a></li>
    </ul>
   </li>
   <li role="menuitem" class="submenu-li" tabindex='-1'>
    <button type="button" id="button-ul-writing" aria-controls="ul-writing" aria-haspopup="menu" class="button-submenu turquoise">Design</button>
    <ul id="ul-design" tabIndex="-1">
     <li><a to="gd-intro" href="#">Intro to Design</a></li>
    </ul>
   </li>
   <li role="menuitem" class="submenu-li" tabindex='-1'>
    <button type="button" id="button-ul-writing" aria-controls="ul-writing" aria-haspopup="menu" class="button-submenu skyblue">User Experience</button>
    <ul id="ul-user-experience" tabIndex="-1">
     <li><a to="ux-intro" href="#">Intro to UX</a></li>
     <li><a to="ux-menus" href="#">User-Friendly Menus</a></li>
    </ul>
   </li>
   <li role="menuitem" class="submenu-li" tabindex='-1'>
    <button type="button" id="button-ul-writing" aria-controls="ul-writing" aria-haspopup="menu" class="button-submenu cobalt">Quality Assurance</button>
    <ul id="ul-quality-assurance" tabIndex="-1">
     <li><a to="qa-intro" href="#">Intro to QA</a></li>
    </ul>
   </li>
   <li role="menuitem" class="submenu-li" tabindex='-1'>
    <button type="button" id="button-ul-writing" aria-controls="ul-writing" aria-haspopup="menu" class="button-submenu blue">Production & Management</button>
    <ul id="ul-production-management" tabIndex="-1">
     <li><a to="ppm-intro" href="#">Intro to Production & Management</a></li>
     <li><a to="ppm-documentation" href="#">Documentation</a></li>
    </ul>
   </li>
   <li role="menuitem" class="submenu-li" tabindex='-1'>
    <button type="button" id="button-ul-writing" aria-controls="ul-writing" aria-haspopup="menu" class="button-submenu purple">Marketing</button>
    <ul id="ul-marketing" tabIndex="-1">
     <li><a to="mkt-intro" href="#">Intro to Marketing</a></li>
     <li><a to="mkt-inbound" href="#">Inbound Marketing</a></li>
     <li><a to="mkt-outbound" href="#">Outbound Marketing</a></li>
    </ul>
   </li>
   <li role="menuitem" class="submenu-li" tabindex='-1'>
    <button type="button" id="button-ul-writing" aria-controls="ul-writing" aria-haspopup="menu" class="button-submenu violet">Finance</button>
    <ul id="ul-finance" tabIndex="-1">
     <li><a to="fm-intro" href="#">Intro to Finance</a></li>
     <li><a to="fm-logistics-projections" href="#">Logistics & Projections</a></li>
     <li><a to="fm-taxes" href="#">Business Taxes</a></li>
    </ul>
   </li>
   <li role="menuitem" class="submenu-li" tabindex='-1'>
    <button type="button" id="button-ul-writing" aria-controls="ul-writing" aria-haspopup="menu" class="button-submenu rose">Business & Legal</button>
    <ul id="ul-biz-legal" tabIndex="-1">
     <li><a to="bl-intro" href="#">Intro to Business & Law</a></li>
     <li><a to="bl-start" href="#">Starting a Business</a></li>
     <li><a to="bl-labor" href="#">Labor & Safety</a></li>
    </ul>
   </li>
  </ul>
 </nav>

 <form id="access-controls" tabIndex="-1" role="dialog" aria-labelledby="ac-title" aria-describedby="ac-desc">
  <h2 id="ac-title">Accessibility Controls</h2>
  <p id="ac-desc">Enhance your experience on the site by operating the settings in the menu below.</p>
  ...
  <ul role="menu" tabIndex="-1">
   <li role="menuitem" tabIndex="-1">
    <label for="theme-choice">Theme Color</label>
    <select id="theme-choice" name="theme-choice">
   ...
   <li role="menuitem" tabIndex="-1">
    <input id="show-content" type="checkbox" name="show-content" value="unfolded">
    <label for="show-content">Display All Content Unfolded (note: this can make the site less accessible.)</label>
   </li>
   <li role="menuitem" id="save-exit" tabIndex="-1">
    <button type="button" aria-label="Save your accessibilities settings." id="buttonAccessSave">Save</button>
    <button type="button" aria-label="Close the accessibilities settings dialog and return to the navigation menu." id="buttonAccessExit">Exit</button>
   </li>
  </ul>
 </form>
 <form id="gen-code" tabIndex="-1" role="dialog" aria-hidden="true" aria-labelledby="gen-title" aria-describedby="gen-desc">
  <h3 id="gen-title" class="gen-group">Generate a Code that can be used in db.js</h3>
  <p id="gen-desc">This is for developer use, but please do send codes to my Twitter!</p>
  <div class="col-left">
   <ul role="menu" tabIndex="-1">
   <li role="menu-item" tabIndex="-1">
    <label for="section">Information Category</label>
    <select id="section" class="select gen-group"></select>
   </li>
   <li role="menu-item" tabIndex="-1">
    <label for="tagSelect">Content Type</label>
    <select id="tagSelect" class="select gen-group">
   ...
   <li role="menu-item" tabIndex="-1">
    <label for="url">Content Source</label>
    <input id="url" class="in gen-group" placeholder="https://..." type="text">
   </li>
   <li role="menu-item" tabIndex="-1">
    <label for="summary">Content Summary</label>
    <input id="summary" class="in gen-group" placeholder="Short summary of item." type="text">
   </li>
   <li role="menu-item" tabIndex="-1">
    <label for="details">Content Details</label>
    <input id="details" class="in gen-group" placeholder="Longer explanation of the item." type="text">
   </li>
   </ul>
  </div>
  <ul role="menu" tabIndex="-1">
   <li role="menu-item" tabIndex="-1">
    <label for="out">Generated code:</label>
    <textarea id="out" class="gen-group"></textarea>
   </li>
   <li role="menu-item" tabIndex="-1">
    <button type="button" class="gen-group" id="copy">Copy code</button>
    <button type="button" class="gen-group" id="close-gen-code">Exit code generator</button>
   </li>
  </ul>
 </form>
 ...
 <main id="main-wrapper" role="main">
  ...
  <div id="welcome">
   ...
   <p id="recommended">
    <a href="#" class="red">Learn C#</a>
    <a href="#" class="scarlet">Worldbuilding</a>
    <a href="#" class="orange">Recording Techniques</a>
    <a href="#" class="yellow">Music Theory</a>
    <a href="#" class="lime">How to Draw</a>
    <a href="#" class="green">Learn Blender 3D</a>
    <a href="#" class="turquoise">Game Design</a>
    <a href="#" class="skyblue">User-Friendliness</a>
    <a href="#" class="cobalt">Testing Techniques</a>
    <a href="#" to="ppm-documentation" class="blue">Design Documents</a>
    <a href="#" to="mkt-inbound" class="purple">Market Research</a>
    <a href="#" to="fm-taxes" class="violet">Business Taxes</a>
    <a href="#" to="bl-start" class="rose">Starting a Business</a>
   </p>
  </div>
 </main>
