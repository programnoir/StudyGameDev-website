/* db.js -- This initializes the database where all resources belong.
...
// ### prog-what-is ############################################################
db.insert( { "section" : "prog-what-is", "tagName" : "Video", "tagColor" : "red",
...
db.insert( { "section" : "prog-what-is", "tagName" : "Wiki", "tagColor" : "yellow",
...
// ### prog-IDES ###############################################################
db.insert( { "section" : "prog-IDEs", "tagName" : "Software", "tagColor" : "purple",
...
db.insert( { "section" : "prog-what-is", "tagName" : "Playlist", "tagColor" : "red",
...
// ### prog-safety #############################################################
db.insert( { "section" : "prog-safety", "tagName" : "Graphic", "tagColor" : "red",
...
db.insert( { "section" : "prog-safety", "tagName" : "Article", "tagColor" : "orange",
...
// ### prog-utilities ##########################################################
db.insert( { "section" : "prog-utilties", "tagName" : "Software", "tagColor" : "purple",
...
db.insert( { "section" : "prog-utilties", "tagName" : "Video", "tagColor" : "red",
...
db.insert( { "section" : "prog-c-books-references", "tagName" : "Book", "tagColor" : "green",
...
db.insert( { "section" : "prog-c-books-references", "tagName" : "Online Manual", "tagColor" : "green",
...
db.insert( { "section" : "prog-c-books-references", "tagName" : "Website", "tagColor" : "yellow",
...
db.insert( { "section" : "prog-lua-books-references", "tagName" : "Website", "tagColor" : "yellow",
...
db.insert( { "section" : "prog-lua-books-references", "tagName" : "Book", "tagColor" : "green",
...
db.insert( { "section" : "prog-love2d-engine-software", "tagName" : "Software", "tagColor" : "purple",
...
db.insert( { "section" : "prog-love2d-engine-basics", "tagName" : "Playlist", "tagColor" : "red",
...
// ### writ-intro-articles #####################################################
db.insert( { "section" : "writ-intro-articles", "tagName" : "Wiki", "tagColor" : "yellow",
...
// ### writ-software ###########################################################
db.insert( { "section" : "writ-software", "tagName" : "Software", "tagColor" : "purple",
...
db.insert( { "section" : "writ-story-fundamentals", "tagName" : "Article", "tagColor" : "orange",
...
// ### sd-intro-articles #######################################################
db.insert( { "section" : "sd-intro-articles", "tagName" : "Article", "tagColor" : "orange",
...
// ### sd-software #############################################################
db.insert( { "section" : "sd-software", "tagName" : "Software", "tagColor" : "purple",
 "url"     : "https://www.audacityteam.org/",
 "summary" : "Audacity",
 "details" : "Simplistic waveform-focused digital audio workstation with tools for directly editing sounds."
} );
// ### sd-pros #################################################################
db.insert( { "section" : "sd-pros", "tagName" : "Channel", "tagColor" : "yellow",
...
db.insert( { "section" : "sd-fundamentals-full", "tagName" : "Playlist", "tagColor" : "red",
...
// ### sd-recording-vocals #####################################################
db.insert( { "section" : "sd-recording-vocals", "tagName" : "Playlist", "tagColor" : "red",
...
db.insert( { "section" : "sd-processing-vocals", "tagName" : "Playlist", "tagColor" : "red",
 "url"     : "https://www.youtube.com/playlist?list=PLOMuI-j1vRxR0GWyKDWFqONkX9RfUG5sG",
 "summary" : "Musician's Guide to Vocal Processing",
 "details" : "Composing Gloves intended this playlist for musicians, but a lot of sound design concepts apply to the synthesis and recording of vocals.\
              Check out the music production section for DAW knowledge."
} );


// ### mp-daws #################################################################
db.insert( { "section" : "mp-daws", "tagName" : "Software", "tagColor" : "purple",
 "url"     : "https://lmms.io",
 "summary" : "LMMS",
...
db.insert( { "section" : "mp-music-theory-courses", "tagName" : "Course", "tagColor" : "blue",
...
db.insert( { "section" : "mp-music-theory-courses", "tagName" : "Playlist", "tagColor" : "red",
...
// ### mp-musician-safety ######################################################
db.insert( { "section" : "mp-musician-safety", "tagName" : "Video", "tagColor" : "red",
...
// ### mp-synthesis ############################################################
db.insert( { "section" : "mp-synthesis", "tagName" : "Wiki", "tagColor" : "yellow",
...
// ### mp-vsts #################################################################
db.insert( { "section" : "mp-vsts", "tagName" : "Website", "tagColor" : "yellow",
...
// ### mp-tracking #############################################################
db.insert( { "section" : "mp-tracking-advice", "tagName" : "Video", "tagColor" : "red",
 "url"     : "https://www.youtube.com/watch?v=-mVK5gTdH_U",
 "summary" : "7 Vocal Recording Tips",
 "details" : "In the Mix describes important tips when recording vocals."
} );
...
// ### mp-mixing ###############################################################
db.insert( { "section" : "mp-mixing", "tagName" : "Playlist", "tagColor" : "red",
...
db.insert( { "section" : "mp-mixing", "tagName" : "Video", "tagColor" : "red",
...
// ### mp-mastering ############################################################
db.insert( { "section" : "mp-mastering", "tagName" : "Video", "tagColor" : "red",
...
db.insert( { "section" : "mp-music-application", "tagName" : "Video", "tagColor" : "red",
...
// ### art-raster-software #####################################################
db.insert( { "section" : "art-raster-software", "tagName" : "Software", "tagColor" : "purple",
...
// ### art-vector-software
db.insert( { "section" : "art-vector-software", "tagName" : "Video", "tagColor" : "red",
...
db.insert( { "section" : "art-vector-software", "tagName" : "Channel", "tagColor" : "yellow",
...
// ### art-safety ##############################################################
db.insert( { "section" : "art-safety", "tagName" : "Graphic", "tagColor" : "red",
 "url"     : "https://twitter.com/gcmulk/status/862478705616093184",
 "summary" : "Injury Risk Reduction Exercises",
 "details" : "These exercises, illustrated by Twitter user gcmulk, are sourced from Summit Medical, McHesson health (2001), HEP2Go. Journals: Bandy and Irion (1997), Page (IJSPT, 2012)"
} );
db.insert( { "section" : "art-safety", "tagName" : "Video", "tagColor" : "red",
...
db.insert( { "section" : "art-safety", "tagName" : "Channel", "tagColor" : "yellow",
...
// ### art-software-assets #####################################################
db.insert( { "section" : "art-software-assets", "tagName" : "Video", "tagColor" : "red",
...
db.insert( { "section" : "art-software-assets", "tagName" : "Download", "tagColor" : "purple",
...
// ### art-databases ###########################################################
db.insert( { "section" : "art-databases", "tagName" : "Website", "tagColor" : "yellow",
...
// ### art-fundamentals ########################################################
db.insert( { "section" : "art-fundamentals", "tagName" : "Course", "tagColor" : "blue",
...
db.insert( { "section" : "art-fundamentals", "tagName" : "Article", "tagColor" : "orange",
...
db.insert( { "section" : "art-fundamentals", "tagName" : "Video", "tagColor" : "red",
 "url"     : "https://www.youtube.com/watch?v=v8jScQhDcNw",
 "summary" : "How to Pick Colors",
 "details" : "Arucelli advises on color theory."
} );
db.insert( { "section" : "art-fundamentals", "tagName" : "Graphic", "tagColor" : "red",
...
db.insert( { "section" : "art-fundamentals", "tagName" : "Playlist", "tagColor" : "red",
...
// ### art-human-anatomy #######################################################
db.insert( { "section" : "art-human-anatomy", "tagName" : "Online Manual", "tagColor" : "green",
...
db.insert( { "section" : "art-human-anatomy", "tagName" : "Website", "tagColor" : "yellow",
...
db.insert( { "section" : "art-human-anatomy", "tagName" : "Graphic", "tagColor" : "red",
...
// ### art-human-skeleton ######################################################
db.insert( { "section" : "art-human-skeleton", "tagName" : "Video", "tagColor" : "red",
...
// ### art-human-head ##########################################################
db.insert( { "section" : "art-human-head", "tagName" : "Video", "tagColor" : "red",
...
db.insert( { "section" : "art-human-head", "tagName" : "Graphic", "tagColor" : "red",
...
db.insert( { "section" : "art-human-hairstyles", "tagName" : "Website", "tagColor" : "yellow",
...
db.insert( { "section" : "art-human-hairstyles", "tagName" : "Graphic", "tagColor" : "red",
...
// ### art-human-eyes ##########################################################
db.insert( { "section" : "art-human-eyes", "tagName" : "Video", "tagColor" : "red",
...
db.insert( { "section" : "art-human-eyes", "tagName" : "Graphic", "tagColor" : "red",
...
// ### art-human-ears ##########################################################
db.insert( { "section" : "art-human-ears", "tagName" : "Graphic", "tagColor" : "red",
...
// ### art-human-torso #########################################################
db.insert( { "section" : "art-human-torso", "tagName" : "Video", "tagColor" : "red",
...
db.insert( { "section" : "art-human-torso", "tagName" : "Graphic", "tagColor" : "red",
...
// ### art-human-arms ##########################################################
db.insert( { "section" : "art-human-arms", "tagName" : "Graphic", "tagColor" : "red",
...
// ### art-human-hands #########################################################
db.insert( { "section" : "art-human-hands", "tagName" : "Graphic", "tagColor" : "red",
...
// ### art-human-waist #########################################################
// ### art-human-legs ##########################################################
db.insert( { "section" : "art-human-legs", "tagName" : "Graphic", "tagColor" : "red",
...
// ### art-human-feet ##########################################################
db.insert( { "section" : "art-human-feet", "tagName" : "Graphic", "tagColor" : "red",
...
// ### art-draw-structures #####################################################
db.insert( { "section" : "art-draw-structures", "tagName" : "Graphic", "tagColor" : "red",
...
// ### art-animals #############################################################
db.insert( { "section" : "art-animals", "tagName" : "Software", "tagColor" : "purple",
...
db.insert( { "section" : "art-animals", "tagName" : "Graphic", "tagColor" : "red",
...
// ### art-draw-materials ######################################################
db.insert( { "section" : "art-draw-materials", "tagName" : "Graphic", "tagColor" : "red",
...
db.insert( { "section" : "art-draw-materials", "tagName" : "Video", "tagColor" : "red",
...
db.insert( { "section" : "art-draw-materials", "tagName" : "Online Manual", "tagColor" : "green",
...
// ### art-nature ##############################################################
db.insert( { "section" : "art-nature", "tagName" : "Article", "tagColor" : "orange",
 "url"     : "https://youtu.be/uaiJNV4hz6s",
 "summary" : "How to Draw A Tree",
 "details" : ""
} );
db.insert( { "section" : "art-nature", "tagName" : "Graphic", "tagColor" : "red",
...
// ### art-weapons #############################################################
db.insert( { "section" : "art-weapons", "tagName" : "Graphic", "tagColor" : "red",
...
// ### art-effects #############################################################
db.insert( { "section" : "art-effects", "tagName" : "Graphic", "tagColor" : "red",
...
// ### art-concept-artist ######################################################
db.insert( { "section" : "art-concept-artist", "tagName" : "Video", "tagColor" : "red",
...
db.insert( { "section" : "art-concept-artist", "tagName" : "Channel", "tagColor" : "yellow",
...
db.insert( { "section" : "art-concept-artist", "tagName" : "Graphic", "tagColor" : "red",
...
// ### art-comic-artist ########################################################
db.insert( { "section" : "art-comic-artist", "tagName" : "Video", "tagColor" : "red",
...
// ### art-sprite-artist #######################################################
db.insert( { "section" : "art-sprite-artist", "tagName" : "Channel", "tagColor" : "yellow",
...
db.insert( { "section" : "art-sprite-artist", "tagName" : "Graphic", "tagColor" : "red",
...
db.insert( { "section" : "art-sprite-artist", "tagName" : "Website", "tagColor" : "yellow",
...
db.insert( { "section" : "art-storyboard-artist", "tagName" : "Article", "tagColor" : "orange",
...
// ### art-2d-aniation #########################################################
db.insert( { "section" : "art-2d-animation", "tagName" : "Course", "tagColor" : "blue",
...
db.insert( { "section" : "art-2d-animation", "tagName" : "Graphic", "tagColor" : "red",
...
db.insert( { "section" : "art-2d-animation", "tagName" : "Video", "tagColor" : "red",
...
db.insert( { "section" : "art-software-techniques", "tagName" : "Video", "tagColor" : "red",
...
db.insert( { "section" : "art-software-techniques", "tagName" : "Graphic", "tagColor" : "red",
...
// ### art-artist-advice #######################################################
db.insert( { "section" : "art-artist-advice", "tagName" : "Graphic", "tagColor" : "red",
...
db.insert( { "section" : "art-artist-advice", "tagName" : "Video", "tagColor" : "red",
...
db.insert( { "section" : "art-artist-advice", "tagName" : "Article", "tagColor" : "orange",
...
db.insert( { "section" : "art-artist-advice", "tagName" : "Website", "tagColor" : "yellow",
...
// ### 3d-what-is ##############################################################
db.insert( { "section" : "3d-what-is", "tagName" : "Video", "tagColor" : "red",
...
// ### 3d-asset-software #######################################################
db.insert( { "section" : "3d-asset-software", "tagName" : "Software", "tagColor" : "purple",
...
// ### 3d-blender ##############################################################
db.insert( { "section" : "3d-blender", "tagName" : "Online Manual", "tagColor" : "green",
...
db.insert( { "section" : "3d-blender", "tagName" : "Course", "tagColor" : "blue",
...
db.insert( { "section" : "3d-blender", "tagName" : "Channel", "tagColor" : "yellow",
...
db.insert( { "section" : "3d-blender", "tagName" : "Download", "tagColor" : "purple",
...
db.insert( { "section" : "3d-blender", "tagName" : "Video", "tagColor" : "red",
...
db.insert( { "section" : "3d-blender", "tagName" : "Graphic", "tagColor" : "red",
...
// ### 3d-3dsmax ###############################################################
db.insert( { "section" : "3d-3dsmax", "tagName" : "Course", "tagColor" : "blue",
...
// ### 3d-maya #################################################################
db.insert( { "section" : "3d-maya", "tagName" : "Channel", "tagColor" : "yellow",
...
// ### 3d-software-assets ######################################################
db.insert( { "section" : "3d-software-assets", "tagName" : "Download", "tagColor" : "purple",
...
db.insert( { "section" : "3d-software-assets", "tagName" : "Website", "tagColor" : "yellow",
...
// ### 3d-free-textures ########################################################
db.insert( { "section" : "3d-free-textures", "tagName" : "Website", "tagColor" : "yellow",
...
// ### 3d-animation ############################################################
db.insert( { "section" : "3d-animation", "tagName" : "Video", "tagColor" : "red",
...
// ### 3d-advice ###############################################################
db.insert( { "section" : "3d-advice", "tagName" : "Video", "tagColor" : "red",
...
db.insert( { "section" : "3d-advice", "tagName" : "Software", "tagColor" : "purple",
...
// ### gd-what-is ##############################################################
db.insert( { "section" : "gd-what-is", "tagName" : "Video", "tagColor" : "red",
...
// ### gd-utilities ############################################################
db.insert( { "section" : "gd-utilities", "tagName" : "Software", "tagColor" : "purple",
 "url"     : "https://www.yworks.com/products/yed",
 "summary" : "yEd Graph Editing Software",
 "details" : "Excellent tool for creating flow charts, UML diagrams, and more."
} );
db.insert( { "section" : "gd-utilities", "tagName" : "Video", "tagColor" : "red",
 "url"     : "https://www.youtube.com/watch?v=UI6lqHOVHic",
 "summary" : "UML Class Diagram Tutorial",
 "details" : "Check this out after you learn a bit about programming. Learn the top-down design tool that is UML and how a diagram software can help you plan your project."
} );
// ### gd-topic-channels ###########################################################
db.insert( { "section" : "gd-topic-channels", "tagName" : "Channel", "tagColor" : "yellow",
...
// ### ux-what-is ##############################################################
db.insert( { "section" : "ux-what-is", "tagName" : "Video", "tagColor" : "red",
...
// ### ux-websites #############################################################
db.insert( { "section" : "ux-websites", "tagName" : "Website", "tagColor" : "yellow",
...
// ### ux-menu-cases ###########################################################
db.insert( { "section" : "ux-menu-cases", "tagName" : "Article", "tagColor" : "orange",
...
// ### qa-what-is ##############################################################
db.insert( { "section" : "qa-what-is", "tagName" : "Video", "tagColor" : "red",
...
// ### ppm-what-is ##############################################################
db.insert( { "section" : "ppm-what-is", "tagName" : "Video", "tagColor" : "red",
...
db.insert( { "section" : "ppm-what-is", "tagName" : "Website", "tagColor" : "yellow",
...
// ### ppm-software ############################################################
db.insert( { "section" : "ppm-software", "tagName" : "Software", "tagColor" : "purple",
...
// ### ppm-design-docs #########################################################
db.insert( { "section" : "ppm-design-docs", "tagName" : "Article", "tagColor" : "orange",
...
// ### mkt-what-is #############################################################
db.insert( { "section" : "mkt-what-is", "tagName" : "Wiki", "tagColor" : "yellow",
...
db.insert( { "section" : "mkt-what-is", "tagName" : "Article", "tagColor" : "orange",
...
// ### mkt-market-research #####################################################
db.insert( { "section" : "mkt-market-research", "tagName" : "Course", "tagColor" : "blue",
...
db.insert( { "section" : "mkt-market-research", "tagName" : "Download", "tagColor" : "purple",
...
db.insert( { "section" : "mkt-market-research", "tagName" : "Website", "tagColor" : "yellow",
...
db.insert( { "section" : "mkt-market-research", "tagName" : "PDF", "tagColor" : "green",
...
// ### mkt-seo #################################################################
db.insert( { "section" : "mkt-seo", "tagName" : "Online Manual", "tagColor" : "green",
 "url"     : "https://moz.com/beginners-guide-to-seo",
 "summary" : "What is SEO? Beginner's Guide to SEO",
 "details" : "Moz is one of the leading authorities on search engine optimization."
} );
db.insert( { "section" : "mkt-seo", "tagName" : "Article", "tagColor" : "orange",
...
// ### mkt-seo-mistakes ########################################################
db.insert( { "section" : "mkt-seo-mistakes", "tagName" : "Article", "tagColor" : "orange",
...
// ### mkt-seo-advanced ########################################################
db.insert( { "section" : "mkt-seo-advanced", "tagName" : "Article", "tagColor" : "orange",
...
db.insert( { "section" : "mkt-seo-advanced", "tagName" : "Video", "tagColor" : "red",
...
// ### mkt-seo-tools ###########################################################
db.insert( { "section" : "mkt-seo-tools", "tagName" : "Software", "tagColor" : "orange",
 "url"     : "https://yoast.com/",
...
db.insert( { "section" : "mkt-seo-tools", "tagName" : "Software", "tagColor" : "purple",
 "url"     : "https://trends.google.com/trends/",
 "summary" : "Google Trend Explorer",
 "details" : "This is an online tool for browsing Google searches for common search terms."
} );
db.insert( { "section" : "mkt-seo-tools", "tagName" : "Video", "tagColor" : "red",
...
db.insert( { "section" : "mkt-unthical-practices", "tagName" : "Video", "tagColor" : "red",
...
// ### mkt-asset-sales #########################################################
db.insert( { "section" : "mkt-asset-sales", "tagName" : "Graphic", "tagColor" : "red",
...
// ### fm-what-is ##############################################################
db.insert( { "section" : "fm-what-is", "tagName" : "Article", "tagColor" : "orange",
...
db.insert( { "section" : "fm-business-plan-templates", "tagName" : "Download", "tagColor" : "purple",
...
// ### fm-business-taxes #######################################################
db.insert( { "section" : "fm-business-taxes", "tagName" : "Article", "tagColor" : "orange",
...
db.insert( { "section" : "fm-business-taxes", "tagName" : "Website", "tagColor" : "yellow",
...
// ### bl-what-is ##############################################################
db.insert( { "section" : "bl-what-is", "tagName" : "Course", "tagColor" : "blue",
...
db.insert( { "section" : "bl-what-is", "tagName" : "Wiki", "tagColor" : "yellow",
...
// ### bl-plans ################################################################
db.insert( { "section" : "bl-plans", "tagName" : "Course", "tagColor" : "blue",
...
db.insert( { "section" : "bl-plans", "tagName" : "Article", "tagColor" : "orange",
...
// ### bl-permits ##############################################################
db.insert( { "section" : "bl-permits", "tagName" : "Website", "tagColor" : "yellow",
...
// ### bl-labor-law ############################################################
db.insert( { "section" : "bl-labor-law", "tagName" : "Website", "tagColor" : "yellow",
 "url"     : "https://www.dol.gov/whd/contacts/state_of.htm",
 "summary" : "US DoL State Directory",
 "details" : "You need an EIN if you are employing anyone or want to open a business bank account."
} );
// ### bl-labor-hiring #########################################################
db.insert( { "section" : "bl-labor-hiring", "tagName" : "Book", "tagColor" : "green",
...
db.insert( { "section" : "bl-labor-hiring", "tagName" : "Website", "tagColor" : "yellow",
...
db.insert( { "section" : "bl-labor-hiring", "tagName" : "Graphic", "tagColor" : "red",
...
db.insert( { "section" : "bl-labor-hiring", "tagName" : "Article", "tagColor" : "orange",
...
// ### bl-labor-safety #########################################################
db.insert( { "section" : "bl-labor-safety", "tagName" : "Book", "tagColor" : "green",
...
db.insert( { "section" : "bl-labor-safety", "tagName" : "Article", "tagColor" : "orange",
...
db.insert( { "section" : "bl-labor-safety", "tagName" : "Graphic", "tagColor" : "red",
 "url"     : "https://twitter.com/gcmulk/status/862478705616093184",
 "summary" : "Injury Risk Reduction Exercises",
 "details" : "These exercises, illustrated by Twitter user gcmulk, are sourced from Summit Medical, McHesson health (2001), HEP2Go. Journals: Bandy and Irion (1997), Page (IJSPT, 2012)"
} );
...
db.insert( { "section" : "bl-labor-environments", "tagName" : "Article", "tagColor" : "orange",
